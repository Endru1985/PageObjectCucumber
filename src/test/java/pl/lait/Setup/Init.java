...
public class Init {
	...
	public static WebDriver getDtiver() {
		
		if(driver == null){
		System.out.println("obiket DRIVERa == NULL - wykonuję new FireFoXDriver()");
		URL hubUrl = null;
		try {
		...
		return driver;
			...
			System.out.println("obiket DRIVERa != NULL - zwracam obiekt)");
		return driver;	
		}
